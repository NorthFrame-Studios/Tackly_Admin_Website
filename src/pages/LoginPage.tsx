  ...
  return (
    <main className="login-page">
      <section className="login-panel" aria-labelledby="login-heading">
        <div className="login-brand"><EquiloMark /><div><strong>equilo</strong><span>Administration</span></div></div>
        ...
        <p className="login-footer">Har du ikke adgang? Kontakt en Equilo-administrator.<br /><Link to="https://equilo.dk">Tilbage til equilo.dk</Link></p>
      </section>
