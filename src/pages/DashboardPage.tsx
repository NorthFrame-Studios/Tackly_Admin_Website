...
export function DashboardPage() {
  ...
  return (
    <><PageHeader title="God arbejdslyst" description="Her er den aktuelle status for Equilo-markedspladsen." actions={<Link to="/reports?status=open" className="button button--primary"><Flag /> Behandl anmeldelser</Link>} />
