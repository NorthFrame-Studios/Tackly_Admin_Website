...
const SupportDetailPage = lazy(() => import('./pages/SupportDetailPage').then((module) => ({ default: module.SupportDetailPage })))
const SettingsPage = lazy(() => import('./pages/SettingsPage').then((module) => ({ default: module.SettingsPage })))

export function App() {
  return <BrowserRouter><AuthProvider><ToastProvider><Suspense fallback={<LoadingState label="Indlæser side…" />}><Routes><Route path="/login" element={<LoginPage />} /><Route element={<ProtectedRoute />}><Route element={<AdminLayout />}><Route index element={<DashboardPage />} /><Route path="reports" element={<ReportsPage />} /><Route path="reports/:reportId" element={<ReportDetailPage />} /><Route path="listings" element={<ListingsPage />} /><Route path="listings/:listingId" element={<ListingDetailPage />} /><Route path="users" element={<UsersPage />} /><Route path="users/:userId" element={<UserDetailPage />} /><Route path="moderation-log" element={<ModerationLogPage />} /><Route path="support" element={<SupportPage />} /><Route path="support/:caseId" element={<SupportDetailPage />} /><Route path="forbidden" element={<ForbiddenPage />} /><Route element={<RoleProtectedRoute adminOnly />}><Route path="settings" element={<SettingsPage />} /></Route><Route path="*" element={<NotFoundPage />} /></Route></Route></Routes></Suspense></ToastProvider></AuthProvider></BrowserRouter>
}
